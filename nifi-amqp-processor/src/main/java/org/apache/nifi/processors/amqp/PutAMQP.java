...
import static org.apache.nifi.processors.amqp.util.QpidAmqpFactory.ATTRIBUTE_PREFIX;
import static org.apache.nifi.processors.amqp.util.QpidAmqpFactory.ATTRIBUTE_TYPE_SUFFIX;
import static org.apache.nifi.processors.amqp.util.QpidAmqpFactory.PROP_TYPE_BOOLEAN;
import static org.apache.nifi.processors.amqp.util.QpidAmqpFactory.PROP_TYPE_BYTE;
import static org.apache.nifi.processors.amqp.util.QpidAmqpFactory.PROP_TYPE_DOUBLE;
import static org.apache.nifi.processors.amqp.util.QpidAmqpFactory.PROP_TYPE_FLOAT;
import static org.apache.nifi.processors.amqp.util.QpidAmqpFactory.PROP_TYPE_INTEGER;
import static org.apache.nifi.processors.amqp.util.QpidAmqpFactory.PROP_TYPE_LONG;
import static org.apache.nifi.processors.amqp.util.QpidAmqpFactory.PROP_TYPE_OBJECT;
import static org.apache.nifi.processors.amqp.util.QpidAmqpFactory.PROP_TYPE_SHORT;
import static org.apache.nifi.processors.amqp.util.QpidAmqpFactory.PROP_TYPE_STRING;
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        try {
            ...
            for (FlowFile flowFile : flowFiles) {
                ...
                final Destination replyToQueue = replyToQueueName == null ? null : QpidAmqpFactory.createQueue(context, replyToQueueName);
