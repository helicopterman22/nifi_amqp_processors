...
*/
  ...
  /*      MapMessage mapMessage = createMapMessage();
        ...
        Map<String, String> mapMessageValues = AmqpConsumer.createMapMessageValues(mapMessage);
        assertEquals("", 4, mapMessageValues.size());
        assertEquals("", "Arnold", mapMessageValues.get(AmqpConsumer.MAP_MESSAGE_PREFIX + "name"));
        assertEquals("", "97", mapMessageValues.get(AmqpConsumer.MAP_MESSAGE_PREFIX + "age"));
        assertEquals("", "89686.564", mapMessageValues.get(AmqpConsumer.MAP_MESSAGE_PREFIX + "xyz"));
        assertEquals("", "true", mapMessageValues.get(AmqpConsumer.MAP_MESSAGE_PREFIX + "good"));
        */
    }
